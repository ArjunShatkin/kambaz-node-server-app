...
export default function WorkingWithArrays(app) {
  ...
  // Route to create a new todo (GET method - returns all todos)
  ...
  // Route to create a new todo (POST method - returns only the new todo)
  ...
  app.get("/lab5/todos/create", createNewTodo);                       // CREATE a new todo (GET - old method)
  app.post("/lab5/todos", postNewTodo);                               // CREATE a new todo (POST - new method)
